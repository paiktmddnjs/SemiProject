...
public class RequestController {
    ...
    public String getRequests(HttpSession session, Model model) {
        ...
        List<RequestVo> requests = requestService.getPendingRequests(loginUser.getMemberId().intValue());
    ...
    public String rejectRequest(@RequestParam("requestId") int requestId, HttpSession session, RedirectAttributes redirectAttributes) {
        ...
        try {
            requestService.rejectRequest(requestId, loginUser.getMemberId().intValue());
        } catch (Exception e) {
    ...
    public String sendInvite(@RequestParam("workspaceId") int workspaceId,
        ...
        try {
            requestService.sendInvite(workspaceId, loginUser.getMemberId().intValue(), email);
